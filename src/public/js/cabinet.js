                ...
                <article class="max-w-md mx-auto  shadow-lg border rounded-md mt-12 bg-white">
                  <div class="min-w-[15rem]">
                    ...
                    <div class="flex justify-between m-[1rem]">
                      ...
                      <div>
                        <a href="https://www.google.com/maps/dir/?api=1&destination=${cabinet.longitude},${cabinet.latitude}" target="_blank" class="text-blue-400 hover:text-blue-600 underline transition-colors duration-300">voir map</a>
                      </div>
                    </div>
                  </div>
                </article>
              ...
              try {
                ...
                if (response.ok) {
                  ...
                  const queryString = Object.keys(cabinetData)
                    .map((key) => key + "=" + encodeURIComponent(cabinetData[key]))
                    .join("&");

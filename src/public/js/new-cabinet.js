document.addEventListener("DOMContentLoaded", () => {
    ...
    const doctorsInput = cabinetForm.querySelector('input[name="doctors"]');
    ...
    submitButton.addEventListener("click", async () => {
      ...
      const doctors = doctorsInput.value.split(',').map(id => id.trim());
      ...
      try {
        ...
        if (response.ok) {
          ...
          } else if (errorData.doctors) {
            errorMessage += errorData.doctors;
          } else {
